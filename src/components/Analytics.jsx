      ...
      >
        ...
        <div className="purple-glow-card" style={{ padding: '20px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
            <span style={{ fontSize: '0.8rem', fontWeight: 600, color: '#c084fc', letterSpacing: '0.05em' }}>
              MONTHLY SPENDING
            </span>
            <div
              style={{
          ...
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#ffffff', fontFamily: 'Outfit, sans-serif' }}>
            {currencySymbol}{totalSpent.toLocaleString('en-IN', { minimumFractionDigits: 0, maximumFractionDigits: 2 })}
          </div>
        ...
        <div className="glass-card" style={{ padding: '20px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '8px' }}>
            <div style={{ fontSize: '1.4rem', fontWeight: 700, color: '#ffffff', fontFamily: 'Outfit, sans-serif' }}>
              {currencySymbol}{remainingBudget.toLocaleString('en-IN')} <span style={{ fontSize: '0.75rem', color: '#a1a1aa', fontWeight: 400 }}>left</span>
            </div>
            <span style={{ fontSize: '0.85rem', fontWeight: 700, color: budgetUsedPercentage > 90 ? '#f87171' : '#c084fc' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
          <div>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#ffffff', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <PieChart style={{ width: '20px', height: '20px', color: '#a855f7' }} /> Spending by Category
            </h3>
                ...
                <div key={item.id}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      <span style={{ fontWeight: 700, fontSize: '0.9rem', color: '#c084fc', marginRight: '8px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
        {topCategory && (
          <div className="glass-card" style={{ padding: '16px', display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            >
              <Award style={{ width: '22px', height: '22px', color: '#a855f7' }} />
            </div>
            <div>
